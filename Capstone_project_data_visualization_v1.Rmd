...
#### Improved Drinking Water Sources: The mean is 83.68%, and the median is 91.00%. The data is left-skewed. There are about 2/3 of the countries with more than 90% of population using improved drinking water sources. Outliers are countries with less than 40% of population using improved drinking water.
