...
# Create model 1 with All independent variables


model1 <- lm(Life_Expectancy ~ Income_per_person + Total_Health_Spending_Per_Person + Government_Health_Spending_Per_Person + Food_Supply + Improved_Water + All_Cancer_Death, data = all_variables_2002)
...
ols_best_subset(model1)

```
```{r}

model_BSR <- lm(Life_Expectancy ~ Government_Health_Spending_Per_Person + Food_Supply + Improved_Water + All_Cancer_Death, data = all_variables_2002)

summary(model_BSR)

SSE=sum(model_BSR$residuals^2)
SSE
...
model_SFR <- lm(Life_Expectancy ~ Income_per_person + Food_Supply + Improved_Water + All_Cancer_Death, data = all_variables_2002)

summary(model_SFR)

SSE=sum(model_SFR$residuals^2)
SSE

```

```{r}
# Create Stepwise Backword Regression
...
```{r}
# Create model 2 with all independent variables except all cancer death

# model2 <- lm(Life_Expectancy ~ Income_per_person + Total_Health_Spending_Per_Person + Government_Health_Spending_Per_Person + Food_Supply + Improved_Water, data = all_variables_2002)
...
```
```{r}
# Create model 3 with all independent variables except income

# model3 <- lm(Life_Expectancy ~ Total_Health_Spending_Per_Person + Government_Health_Spending_Per_Person + Food_Supply + Improved_Water + All_Cancer_Death, data = all_variables_2002)
...
```{r}
# Create model 4 with all independent variables except total health spending

# model4 <- lm(Life_Expectancy ~ Income_per_person + Government_Health_Spending_Per_Person + Food_Supply + Improved_Water + All_Cancer_Death, data = all_variables_2002)
...
```
```{r}
# Create model 5 with all independent variables except government health spending

# model5 <- lm(Life_Expectancy ~ Income_per_person + Total_Health_Spending_Per_Person + # Food_Supply + Improved_Water + All_Cancer_Death, data = all_variables_2002)
...
```{r}
# Create model 6 with all independent variables except total and government health spending

# model6 <- lm(Life_Expectancy ~ Income_per_person + Food_Supply + Improved_Water + All_Cancer_Death, data = all_variables_2002)
