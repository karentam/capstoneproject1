...
## 3-fold Cross-Validation for all 6 variables
...
cv.lm(all_variables_last5yrs_df, form.lm = formula(Life_Expectancy ~ .), m=3)


## 3-fold Cross-Validation for 4 stronger predictor variables based on Best Subset and Stepwise Forward
...
cv.lm(all_variables_last5yrs_df_4p_iwfc, form.lm = formula(Life_Expectancy ~ .), m=3)


## 3-fold Cross-Validation for 4 stronger predictor variables based on Random Forest
...
cv.lm(all_variables_last5yrs_df_4p_iwtg, form.lm = formula(Life_Expectancy ~ .), m=3)
