...
ggplot(income_pp_year_as_row, aes(x = Income_per_person)) + geom_density() + labs(x = "GDP Per Capita (US$)", y = "Density", title = "Density Plot of Income Per Person") + scale_x_log10(breaks = scales::trans_breaks("log10", function(x) 10^x), labels = scales::trans_format("log10", scales::math_format(10^.x)))
...
ggplot(income_pp_year_as_row, aes(x = Income_per_person)) + stat_ecdf(geom = "point") + labs(x = "GDP Per Capita (US$)", y = "F(Income)", title = "Empirical Cumulative Density Function of Income Per Person")
...
ggplot(life_expectancy_year_as_row, aes(x = Life_Expectancy)) + geom_density() + labs(x = "Life Expectancy (Year)", y = "Density", title = "Density Plot of Life Expectancy") + scale_x_log10(breaks = scales::trans_breaks("log10", function(x) 10^x), labels = scales::trans_format("log10", scales::math_format(10^.x)))
...
ggplot(total_health_spending_pp_year_as_row, aes(x = Total_Health_Spending_Per_Person)) + geom_density() + labs(x = "Total Health Spending Per Person (US$)", y = "Density", title = "Density Plot of Total Health Spending Per Person in US$") + scale_x_log10(breaks = scales::trans_breaks("log10", function(x) 10^x), labels = scales::trans_format("log10", scales::math_format(10^.x)))
...
ggplot(government_health_spending_pp_year_as_row, aes(x = Government_Health_Spending_Per_Person)) + geom_density() + labs(x = "Government Health Spending Per Person (US$)", y = "Density", title = "Density Plot of Government Health Spending Per Person in US$") + scale_x_log10(breaks = scales::trans_breaks("log10", function(x) 10^x), labels = scales::trans_format("log10", scales::math_format(10^.x)))
...
ggplot(food_supply_year_as_row, aes(x = Food_Supply)) + geom_density() + labs(x = "Food Supply by Calories Per Person Per Day", y = "Density", title = "Density Plot of Food Supply") + scale_x_log10(breaks = scales::trans_breaks("log10", function(x) 10^x), labels = scales::trans_format("log10", scales::math_format(10^.x)))
...
ggplot(food_supply_year_as_row, aes(x = Food_Supply)) + stat_ecdf(geom = "point") + labs(x = "Food Supply by Calories Per Person Per Day", y = "F(Food Supply)", title = "Empirical Cumulative Density Function of Food Supply")
...
subset(food_supply_year_as_row, Food_Supply > 3500)
...
ggplot(improved_drinking_water_year_as_row, aes(x = Improved_Water)) + geom_density() + labs(x = "Percentage of Population Using Improved Drinking Water Sources", y = "Density", title = "Density Plot of Improved Drinking Water Sources") + scale_x_log10(breaks = scales::trans_breaks("log10", function(x) 10^x), labels = scales::trans_format("log10", scales::math_format(10^.x)))
...
ggplot(improved_drinking_water_year_as_row, aes(x = Improved_Water)) + stat_ecdf(geom = "point") + labs(x = "Percentage of Population Using Improved Drinking Water Sources", y = "F(Improved Drinking Water Sources)", title = "Empirical Cumulative Density Function of Improved Drinking Water Sources")
...
cor_life_tothealthspend <- paste("r = ", round(cor_life_tothealthspend, 2), "(4 years combined)")
...
# Descriptive Statistics of totao_cancer_death_2002
summary(total_cancer_death_2002)

# Correlation Coefficient for life expectancy and total cancer death
cor_life_totc <- cor(total_cancer_death_2002$All_Cancer_Death, total_cancer_death_2002$Life_Expectancy, use = "complete.obs")

cor_life_totc <- paste("r = ", round(cor_life_totc, 2))

# Scatterplot - Total cancer death per 100000 person
ggplot(total_cancer_death_2002, aes(x = All_Cancer_Death, y = Life_Expectancy)) + geom_point(size = 3, alpha = 0.5, position = "jitter") + labs(x = "All Cancer Deaths Per 100,000 Person", y = "Life Expectancy (Year)", title = "All Cancer Death and Life Expectancy in 2002", subtitle = cor_life_totc) + geom_smooth(method = "lm", linetype = 2) + scale_x_log10(breaks = scales::trans_breaks("log10", function(x) 10^x), labels = scales::trans_format("log10", scales::math_format(10^.x)))

# Density Plot for total_cancer_death_2002

ggplot(total_cancer_death_2002, aes(x = All_Cancer_Death)) + geom_density() + labs(x = "Total Cancer Death Per 100000 Person", y = "Density", title = "Density Plot of Total Cancer Death Per 100000 Person in 2002") + scale_x_log10(breaks = scales::trans_breaks("log10", function(x) 10^x), labels = scales::trans_format("log10", scales::math_format(10^.x)))

# Empirical Cumulative Density Function Plot for total_cancer_death_2002

ggplot(total_cancer_death_2002, aes(x = All_Cancer_Death)) + stat_ecdf(geom = "point") + labs(x = "Total Cancer Death Per 100000 Person", y = "F(Total Cancer Death)", title = "Empirical Cumulative Density Function of Total Cancer Death \nPer 100000 Person in 2002")
