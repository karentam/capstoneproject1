...
ggplot(income_pp_year_as_row, aes(x = Income_per_person)) + geom_density() + scale_x_continuous(name = "GDP Per Capita (US$)", breaks = seq(0, 80000, 20000), limits=c(0, 80000)) + scale_y_continuous(name = "Density") + ggtitle("Density Plot of Income Per Person") 
...
ggplot(life_expectancy_year_as_row, aes(x = Life_Expectancy)) + geom_density() + scale_x_continuous(name = "Life Expectancy (Year)") + scale_y_continuous(name = "Density") + ggtitle("Density Plot of Life Expectancy") 
...
ggplot(total_health_spending_pp_year_as_row, aes(x = Total_Health_Spending_Per_Person)) + geom_density() + scale_x_continuous(name = "Total Health Spending Per Person (US$)", breaks = seq(0, 5000, 1000), limits=c(0, 5000)) + scale_y_continuous(name = "Density") + ggtitle("Density Plot of Total Health Spending Per Person in US$")
...
ggplot(government_health_spending_pp_year_as_row, aes(x = Government_Health_Spending_Per_Person)) + geom_density() + scale_x_continuous(name = "Government Health Spending Per Person (US$)", breaks = seq(0, 4000, 1000), limits=c(0, 4000)) + scale_y_continuous(name = "Density") + ggtitle("Density Plot of Government Health Spending Per Person in US$")
...
ggplot(food_supply_year_as_row, aes(x = Food_Supply)) + geom_density() + scale_x_continuous(name = "Food Supply by Calories Per Person Per Day") + scale_y_continuous(name = "Density") + ggtitle("Density Plot of Food Supply")
...
ggplot(improved_drinking_water_year_as_row, aes(x = Improved_Water)) + geom_density() + scale_x_continuous(name = "Percentage of Population Using Improved Drinking Water Sources") + scale_y_continuous(name = "Density") + ggtitle("Density Plot of Improved Drinking Water Sources")
...
ggplot(total_cancer_death_2002, aes(x = All_Cancer_Death)) + geom_density() + scale_x_continuous(name = "Total Cancer Death Per 100000 Person") + scale_y_continuous(name = "Density") + ggtitle("Density Plot of Total Cancer Death Per 100000 Person")
