...
Some studies suggested that people living in poverty have shorter life spans. From the equity standpoint, everyone should have the equal right to survive. Therefore, it is important to examine elements that are associated with life expectancy, and governments have responsibilities to close the gap of the inequality in terms of developing and implementing public policies. 
...
Pearson Correlation Coefficient and Multiple linear regression were used to infer causal relationships between life expectancy and independent variables used in this project. Income, improved drinking water source, and food supply are related to life expectancy based on these two tests. Although cancer death is not significantly correlated with life expectancy, it is significant to the regression model. On the other hand, total and government health spending is correlated with life expectancy but not significant to the regression model. 

<br>

### Dataset

Data of seven variables from 1960 to 2016 are from the Gapminder, an independent Swedish foundation with no political, religious or economic affiliations. Each variable has its own dataset. A consolidated dataset was created by combining different variable datasets. 
...
<th>
r for the Latest Available Year
</th>
<th>
...
Tthe total health spending/government health spending and life expectancy have a moderate, positive relationship.  
...
Using data from about different countries in 1997 and 2007, the plot suggests that not having enough calories intake can threaten people's lives. The correlations suggest that food supply and life expectancy have a strong, positive relationship. 
...
Using data from different countries from 1997 to 2007, the plot shows the positive relationship between life expectancy and percentage of the total population using improved drinking water sources. The correlations suggest that improved drinking water sources and life expectancy have a strong, positive relationship. 
...
The plot is created on square root scale. There were 108 countries in 2007 and 97 countries in 1997 that could provide clean drinking water sources to more than 90% of the population. So many points are located close to 100%. 
...
The correlation suggests that cancer death and life expectancy have a very weak, negative relationship. Cancer is not the major reason for death nowadays, especially in richer countries, because of widespread screening programs that detect cancers at the early and treatable stage. 
...
<td>
Income
<br>Improved Drinking Water Source
<br>Food Supply
<br>Cancer Death
</td>
<td>
...
Income
<br>Improved Drinking Water Source
<br>Total Health Spending
<br>Government Health Spending
</td>
<td>
...
<td>
Best Subsets Regression
<br>Stepwise Forward regression
</td>
<td>
0.69
</td>
...
The selected model includes 4 significant predictor variables: income, food supply, improved drinking water source, and cancer death
...
<td>
An Increase of $7,002.80 in GDP Per Capita
</td>
</tr>
...
<td>
An increase in 2.81% of country's population with an access to clean drinking water sources
</td>
</tr>
...
<td>
An increase in 453.31 calories intake per person per day
<br>
...
<br>
B. <a href="https://github.com/karentam/capstoneproject1/blob/master/Capstone_Final_Appendix_Correlation_Code_Output.pdf">R Code and Output of the Pearson Correlation Coefficient</a>
B. <a href="https://github.com/karentam/capstoneproject1/blob/master/Capstone_Final_Appendix_Regression_Code_Output.pdf">R Code and Output of the Multiple Linear Regression</a>. 
