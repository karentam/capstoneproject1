...
**Cleaning and Wrangling**
  ...
  + Reshape the data for plots and statistical analysis
    ...
    + In each row, I summed numbers of different types of cancer and created a column to store the total number of cancer deaths. 
...
From the equity standpoint, country and local governments, public health researchers, heathcare facilities, and community nonprofits are critical to close the inequality gap in life expectancy. Recommendations for these stakeholders are as follows:
...
<br>
C. <a href="https://github.com/karentam/capstoneproject1/blob/master/Capstone_Final_Appendix_Regression_Code_Output.pdf">R Code and Output of the Multiple Linear Regression</a>
