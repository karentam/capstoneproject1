...
**Cleaning and Wrangling**
  ...
  + Join the data from different datasets
    ...
    + I used full_join () and inner_join() in dplyr package to join variables together into a dataset. I also calculated total numbers of cancer death for each country in different years by adding numbers of various male and female cancer death. 
...
The dataset used in this test contains the most updated available data in 2002 from the Gapminder. A total of 276 observations/countries are in the dataset, in which 127 observations have missing data. 

**Variable Selection**

Best Subsets Regression and Stepwise Forward Regression methods are used to select predictor variables that do the best at predicting life expectancy. The predict variables are selected based on the Adjusted R-Squared. Sum of Squared Errors is also considered when comparing the best models in the results of the Best Subsets Regression and Stepwise Forward Regression. 

<br>

_Result of Best Subsets Regression_ 

![](https://github.com/karentam/capstoneproject1/blob/master/Best_subsets_regression_result.png?raw=true)

<br> 

Best Model shown in the Best Subsets Regression Based on the Adjusted R-Squared:

  + Dependent variable: Life Expectancy
  + Independent variables: Government Health Spending, Food Supply, Improved Drinking Water Source, and Cancer Death
  + Adjusted R-Squared: 0.6802
  + Sum of Squared Errors: 4469.646

<br>

_Result of Stepwise Forward Regression_

![](https://github.com/karentam/capstoneproject1/blob/master/Stepwise_forward_regression_result.png?raw=true)

<br>

Best Model shown in Stepwise Forward Regression Based on the Adjusted R-Squared:

  + Dependent variable: Life Expectancy
  + Independent variables: Income, Food Supply, Improved Drinking Water Source, and Cancer Death
  + Adjusted R-Squared: 0.6759
  + Sum of Squared Errors: 4652.93

The best model from the Best Subsets Regression is choosen because it has the larger Adjusted R-Squared and lower Sum of Squared Errors. 

<br>

**Analysis Based on the Best Model**

![](https://github.com/karentam/capstoneproject1/blob/master/Model_BSR_individual_regression_result.png?raw=true)

There are 276 observations, in which 123 of them have missing data in this model. Predictors include government health spending, food supply, improved drinking water source, and cancer death.

Adjusted R-Squared:
The Adjusted R-Squared of 0.6802 suggests that about 68% of variation in life expectancy can be explained by this model. 

P-Value:
Government health spending, food supply, and improved drinking water sources are significant because their p-values are less than 0.05. Statistically significant means that the result is likely not due to random chance. Cancer death has a p-value of 0.1038. If the level of confidence is 90%, cancer death is very close to be a significant variable. 

Residual Standard Error:
Residual Standard Error of 5.495 shows that there are about 5.5 years between the observed life expectancy and predicted life expectancy. 

Estimated Effect of Predictors:
  + An increase of US$1 in government health spending is associated with an increase of 0.0017 year in life expectancy. 
  + An increase of 1 calory intake is associated with an increase of 0.0054 year in life expectancy.
  + An increase in 1% of country's population with an access to clean drinking water sources is associated with an increase in 0.2845 year in life expectancy.
  + A decrease in 1 case of cancer death per 100,000 person per year is associated with an increase of 0.0242 year in life expectancy. 
