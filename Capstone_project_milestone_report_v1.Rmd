...
Data from 200 countries is used in plots below. GDP Per Capita by country is not normally distributed. 
...
<h6>Observation: 14,196. Observation containing missing data: 6,208.</h6>
...
Data on life expectancy was from 209 countries. The data is left-skewed, suggesting that the majority of countries have the longer life expectancy. 
...
<tr>
<td colspan="2" align="center">
<h6>Observation: 15,561. Observation containing missing data: 3,931.</h6>
...
Data on total health spending was from 189 countries. It is not normally distributed and is right-skewed. There are 3/4 of countries with the total health spending per person of US$564 or less. 
...
<tr>
<td colspan="2" align="center">
<h6>Observation: 4,368. Observation containing missing data: 1,360.</h6>
...
Data on government health spending was from 191 countries. Similar to the total health spending, it is not normally distributed and is right-skewed. There are about 3/4 of the countries with the government health spending per person of US$460 or less. 
...
<tr>
<td colspan="2" align="center">
<h6>Observation: 4,368. Observation containing missing data: 1,329.</h6>
...
Data on improved drinking water sources was from 201 countries. The data is left-skewed, and there are about 2/3 of the countries with more than 90% of the population using improved drinking water sources. 
...
<tr>
<td colspan="2" align="center">
<h6>Observation: 12,831. Observation containing missing data: 5,331.</h6>
...
Data on various cancer deaths was from 174 countries in 2002. The most updated available data is 2002's. The types of cancer include breast, cervical, liver, stomach, lung, and prostate. The data is almost normally distributed but is still right-stewed. 
...
<tr>
<td colspan="2" align="center">
<h6>Observation: 276. Observation containing missing data: 102.</h6>
...
The dataset used in this test contains the most updated available data in 2002 from the Gapminder. A total of 149 observations (countries/territories) are in the dataset. There is no missing data. 

**Cross-Validation**

The dataset is split into a training set and a testing set. The regression model is built based on the training set. Prediction is performed on the testing set. 

**Variable Selection**

After creating a training set and a testing set, Best Subsets Regression, Stepwise Forward Regression, and Random Forest are performed to select predictor variables that do the best at predicting life expectancy. The predict variables are selected based on the Adjusted R-Squared. Sum of Squared Errors is also considered when comparing the models.

<br>

_Result of Best Subsets Regression_ 

![](https://github.com/karentam/capstoneproject1/blob/bad16ce8e9aedf38a09ec2dcad7584e8718b3e81/Best_subsets_regression_result.png?raw=true)

<br> 

The best model:

  + Dependent/Outcome variable: Life Expectancy
  + Independent/Predictor variables: Income, Food Supply, Improved Drinking Water Source, and Cancer Death
...
![](https://github.com/karentam/capstoneproject1/blob/bad16ce8e9aedf38a09ec2dcad7584e8718b3e81/Stepwise_forward_regression_result.png?raw=true)
...
![](https://github.com/karentam/capstoneproject1/blob/bad16ce8e9aedf38a09ec2dcad7584e8718b3e81/Random_forest_result.png?raw=true)
...
The best model:
  ...
  + Dependent/Outcome variable: Life Expectancy
  + Independent/Predictor variables: Income, Food Supply, Improved Drinking Water Source, Total Health Spending, and Government Health Spending

_Comparison of Models_
...
<td>
<font color="red">0.6606</font>
</td>
<td>
<font color="red">0.6926</font>
</td>
<td>
3411.14
</td>
...
<tr>
<td>
Income, Food Supply, Improved Water Source, Total Health Spending, and Government Health Spending
</td>
<td>
0.6539
</td>
...
The model with predictor variables Income, Food Supply, Improved Water Source, and Cancer Death has the highest Adjusted R-Squared of 0.6606 and the highest Out-of-Sample R-Squared of 0.6926. Its Sum of Squared Errors of 3411.14 is close to the smallest one in the model with 6 predictors. Therefore, it is selected as the best model to predict life expectancy.

**Analysis Based on the Best Model**

![](https://github.com/karentam/capstoneproject1/blob/bad16ce8e9aedf38a09ec2dcad7584e8718b3e81/Regression_AllVariables2002Log4p_result.png?raw=true)

There are 149 observations in this model without any missing data. Predictors include income, food supply, improved drinking water source, and cancer death.

Adjusted R-Squared:
The Adjusted R-Squared of 0.6606 suggests that about 66% of variation in life expectancy can be explained by this model. 

P-Value:
Food supply and improved drinking water sources are significant because their p-values are less than 0.05. Statistically significant means that the result is likely not due to random chance. Income has a p-value of 0.1345. If the level of confidence is 90%, income is very close to be a significant variable. On the other hand, cancer death has a p-value of 0.2757, which is not significant to the model. 

Residual Standard Error:
Residual Standard Error of 5.87 shows that there are about 5.87 years between the observed life expectancy and predicted life expectancy. 

Estimated Effect of Predictors:
  + An increase of US$1 in GDP Per Capita is associated with an increase of 0.0001904 year in life expectancy. 
  + An increase of 1 calory intake is associated with an increase of 0.006685 year in life expectancy.
  + An increase in 1% of country's population with an access to clean drinking water sources is associated with an increase in 0.2787 year in life expectancy.
  + A decrease in 1 case of cancer death per 100,000 person per year is associated with an increase of 0.01989 year in life expectancy. 
