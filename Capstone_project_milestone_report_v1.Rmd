...
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/d41f97f2f72c534b818d69de0d44c52a921c9733/ECDFPlot_Income_Annot.png?raw=true">
</td>
</tr>
<tr>
...
<tr>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/d41f97f2f72c534b818d69de0d44c52a921c9733/DensityPlot_Life_Annot.png?raw=true">
</td>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/d41f97f2f72c534b818d69de0d44c52a921c9733/ECDFPlot_Life_Annot.png?raw=true">
</td>
</tr>
<tr>
<td colspan="2" align="center">
...
<tr>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/d41f97f2f72c534b818d69de0d44c52a921c9733/DensityPlot_TotHealthSpend_Log10_Annot.png?raw=true">
</td>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/d41f97f2f72c534b818d69de0d44c52a921c9733/ECDFPlot_TotHealthSpend_Annot.png?raw=true">
</td>
</tr>
<tr>
<td colspan="2" align="center">
...
<tr>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/d41f97f2f72c534b818d69de0d44c52a921c9733/DensityPlot_GovHealthSpend_Log10_Annot.png?raw=true">
</td>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/d41f97f2f72c534b818d69de0d44c52a921c9733/ECDFPlot_GovHealthSpend_Annot.png?raw=true">
</td>
</tr>
<tr>
<td colspan="2" align="center">
...
<tr>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/7b8583b73c19fc1ded53979dcf76de53b59bbf75/DensityPlot_Water_Annot.png?raw=true">
</td>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/7b8583b73c19fc1ded53979dcf76de53b59bbf75/ECDFPlot_Water_Annot.png?raw=true">
</td>
</tr>
<tr>
<td colspan="2" align="center">
...
<tr>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/7b8583b73c19fc1ded53979dcf76de53b59bbf75/DensityPlot_Food_Annot.png?raw=true">
</td>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/7b8583b73c19fc1ded53979dcf76de53b59bbf75/ECDFPlot_Food_Annot.png?raw=true">
</td>
</tr>
<tr>
<td colspan="2" align="center">
...
<tr>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/7b8583b73c19fc1ded53979dcf76de53b59bbf75/DensityPlot_TotC_Annot.png?raw=true">
</td>
<td>
<img src="https://github.com/karentam/capstoneproject1/blob/7b8583b73c19fc1ded53979dcf76de53b59bbf75/ECDFPlot_TotC_Annot.png?raw=true">
</td>
</tr>
<tr>
<td colspan="2" align="center">
...
Using data from different countries in 1960 and 2010, the plot shows that the higher the income, the longer life the person has. However, the difference in life expectancy between wealthy and poor countries is getting smaller in the most recent decades. 
...
<h6>Observation: 540. Observation containing missing data: 267.</h6>
<h6>Source: 
<br>
...
<h6>Observation: 1,092. Observation containing missing data: 375.</h6>
<h6>Source: 
<br>
...
<h6>Observation: 1,092. Observation containing missing data: 368.</h6>
<h6>Source: 
<br>
...
<h6>Observation: 546. Observation containing missing data: 199.</h6>
<h6>Source: 
<br>
<a href="http://docs.google.com/spreadsheet/pub?key=0AkBd6lyS3EmpdHo5S0J6ekhVOF9QaVhod05QSGV4T3c&output=xlsx" target="_blank">Gapminder, Income per person (GDP/capita, PPP$ inflation-adjusted)</a> 
<br>
...
<h6>Observation: 546. Observation containing missing data: 182.</h6>
<h6>Source: 
<br>
<a href="http://docs.google.com/spreadsheet/pub?key=0AkBd6lyS3EmpdHo5S0J6ekhVOF9QaVhod05QSGV4T3c&output=xlsx" target="_blank">Gapminder, Income per person (GDP/capita, PPP$ inflation-adjusted)</a> 
<br>
...
Using data from 174 countries in 2002, the plot shows that there is a slight, negative relationship between life expectancy and total cancer death. When cancer death increases, the length of life decreases. The total number of cancer death here includes breast, cervical, lung, liver, stomach, and prostate cancers. 

The correlation of -0.05 suggests that cancer death and life expectancy have a very weak, negative relationship. Cancer is not the major reason for death nowadays, especially in richer countries, because of widespread screening programs that detect cancers at the early and treatable stage. 

![](https://github.com/karentam/capstoneproject1/blob/master/ScatterPlot_AllCLife_CI_r_Annot.png?raw=true)
<h6>Observation: 276. Observation containing missing data: 103.</h6>
<h6>Source: 
<br>
<a href="http://docs.google.com/spreadsheet/pub?key=0AkBd6lyS3EmpdHo5S0J6ekhVOF9QaVhod05QSGV4T3c&output=xlsx" target="_blank">Gapminder, Income per person (GDP/capita, PPP$ inflation-adjusted)</a> 
<br>
...
Multiple Linear Regression is used to test how the change in predictor variables predicts the level of change in life expectancy. 
...
![](https://github.com/karentam/capstoneproject1/blob/8c777ce1bc05e366120b4fd9cdc47b7514b5a8fc/wholeds_regression_result.png?raw=true)

<br>

  + 346 observations
  + Adjusted R-Squared: 0.6898
  + Sum of Squared Errors: 6761.735
...
Best Subsets Regression, Stepwise Forward Regression, and Random Forest are performed to select predictor variables that do the best at predicting life expectancy. The predict variables are selected based on the Adjusted R-Squared. Sum of Squared Errors is also considered when comparing the models.

<br>

_Result of Best Subsets Regression_ 

![](https://github.com/karentam/capstoneproject1/blob/8c777ce1bc05e366120b4fd9cdc47b7514b5a8fc/wholeds_best_subset_result.png?raw=true)
...
![](https://github.com/karentam/capstoneproject1/blob/8c777ce1bc05e366120b4fd9cdc47b7514b5a8fc/wholeds_stepwise_forward_result.png?raw=true)
...
![](https://github.com/karentam/capstoneproject1/blob/8c777ce1bc05e366120b4fd9cdc47b7514b5a8fc/wholeds_outputforest_result.png?raw=true)
...
The best model:
  ...
  + Mean of squared Residuals of Out-of-Bag predictions versus targets: 14
  + Percentage of Variable Explained: 78.2 
  + Pseudo R-Squared: 0.78
  
<br>
  
We will compare a model containing Income, Improved Drinking Water Source, Food Supply, and Cancer Death to another model containing Income, Improved Drinking Water Source, Total Health Spending, and Government Health Spending. 

<br>

**Compare Two Models With Different Predictors Varables Using The Whole Dataset**

_Predictor Variables: Income, Improved Drinking Water Source, Food Supply, and Cancer Death_

![](https://github.com/karentam/capstoneproject1/blob/8c777ce1bc05e366120b4fd9cdc47b7514b5a8fc/wholeds_4p_iwfc_regression_result.png?raw=true)

<br>

_Predictor Variables: Income, Improved Drinking Water Source, Total Health Spending, Government Health Spending_

![](https://github.com/karentam/capstoneproject1/blob/8c777ce1bc05e366120b4fd9cdc47b7514b5a8fc/wholeds_4p_iwtg_regression_result.png?raw=true)
...
<tr>
<td>
Income, Food Supply, Improved Water Source, Cancer Death, Total Health Spending, and Government Health Spending
</td>
<td>
0.6898
</td>
...
<tr>
<td>
Income, Food Supply, Improved Water Source, and Cancer Death
</td>
<td>
0.691
</td>
...
<tr>
<td>
Income, Improved Water Source, Total Health Spending, and Government Health Spending
</td>
<td>
0.673
</td>
...
The predictor variable combination of Income, Improved Drinking Water Source, Food Supply, and Cancer Death in the second model has the highest Adjusted R-Squared of 0.691. Its Sum of Squared Errors of 6779 is close to the best Sum of Squared Errors in this table. 

<br>

**Cross-Validation**

The dataset is split into a training set and a testing set. Models created by training sets with different threshold ratios (0.5, 0.6, 0.7, and 0.8) are compared by linear regression. Testing sets are also used to make predictions. 

<br>

_Threshold Value 0.5 With All 6 Predictor Variables_
![](https://github.com/karentam/capstoneproject1/blob/master/train1_cv_6p_regression_result_p1.png?raw=true)
![](https://github.com/karentam/capstoneproject1/blob/master/train1_cv_6p_regression_result_p2.png?raw=true)

<br>

_Threshold Value 0.6 With All 6 Predictor Variables_
![](https://github.com/karentam/capstoneproject1/blob/8c777ce1bc05e366120b4fd9cdc47b7514b5a8fc/train2_cv_6p_regression_result_p1.png?raw=true)
![](https://github.com/karentam/capstoneproject1/blob/8c777ce1bc05e366120b4fd9cdc47b7514b5a8fc/train2_cv_6p_regression_result_p2.png?raw=true)

<br>

_Threshold Value 0.7 With All 6 Predictor Variables_
![](https://github.com/karentam/capstoneproject1/blob/8c777ce1bc05e366120b4fd9cdc47b7514b5a8fc/train3_cv_6p_regression_result_p1.png?raw=true)
![](https://github.com/karentam/capstoneproject1/blob/8c777ce1bc05e366120b4fd9cdc47b7514b5a8fc/train2_cv_6p_regression_result_p2.png?raw=true)

<br>

_Threshold Value 0.8 With All 6 Predictor Variables_
![](https://github.com/karentam/capstoneproject1/blob/master/train4_cv_6p_regression_result_p1.png?raw=true)
![](https://github.com/karentam/capstoneproject1/blob/master/train1_cv_6p_regression_result_p2.png?raw=true)
...
The best model for predicting life expectancy is the one with 0.7 threshold value because it has the highest Adjusted R-Squared of 0.697. It is also higher than the Adjusted R-Squared (0.6898) of the model created by the whole dataset and all 6 predictor variables. In addition, the Sum of Squared Errors of the 0.7 threshold value model (5410) is relatively small. 

<br>

_Question: Out of sample R-Squared: -0.99. It has the negative value. Is it a strong Out of Sample R-squared?_
...
![](https://github.com/karentam/capstoneproject1/blob/master/train1_cv_result_error_p1.png?raw=true)
<br>
![](https://github.com/karentam/capstoneproject1/blob/master/train1_cv_result_error_p2.png?raw=true)
<br>
![](https://github.com/karentam/capstoneproject1/blob/master/train1_cv_result_error_p3.png?raw=true)
<br>


**Create the Best Model**

The best model is generated by the training set with 0.7 threshold rate and 4 significant predictor variables.

<br>

![](https://github.com/karentam/capstoneproject1/blob/master/train3_cv_4p_regression_result_p1.png?raw=true)
![](https://github.com/karentam/capstoneproject1/blob/master/train3_cv_4p_regression_result_p2.png?raw=true)

<br>

There are 346 observations without missing data. This model includes 4 significant predictor variables: income, food supply, improved drinking water source, and cancer death

Adjusted R-Squared: 0.699
<br>
69.9% of variation in life expectancy can be explained by this model. 
...
<br>
Residual Standard Error of 4.66 shows that there are about 4.66 years between the observed life expectancy and predicted life expectancy. 

Estimated Effect of Predictors:
<br>
  + An increase of US$1 in GDP Per Capita is associated with an increase of 0.000156 year in life expectancy. 
  + An increase of 1 calory intake is associated with an increase of 0.00274 year in life expectancy.
  + An increase in 1% of country's population with an access to clean drinking water sources is associated with an increase in 0.344 year in life expectancy.
  + A decrease in 1 case of cancer death per 100,000 person per year is associated with an increase of 0.0361 year in life expectancy. 
