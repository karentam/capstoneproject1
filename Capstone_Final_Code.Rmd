...
# pairs - Charts to pair Income, Life Expectancy, Total and Government Health Spending, Food supply, Improved Water, and All Cancer Death
pairs(~log10(Income_per_person)+Life_Expectancy+log10(Total_Health_Spending_Per_Person)+log10(Government_Health_Spending_Per_Person)+Improved_Water+Food_Supply+All_Cancer_Death, data=total_cancer_death_last5yrs)
