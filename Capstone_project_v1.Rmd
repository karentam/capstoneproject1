...
# Standard Deviation of breast cancer death per 100,000 female
ipp_sd <- round(sd(breast_cancer_death_year_as_row$Breast_Cancer_Death, na.rm = TRUE), 2)
paste("The Standard Deviation of breast cancert death per 100,000 female is ", ipp_sd, ".")

# Histogram showing breast cancer death in different countries

hist(breast_cancer_death$`2000`, xlab="Breast Cancer Death Per 100,000 Female 2000", main="Breast Cancer Dealths In Different Countries in 2000")
...
# Standard Deviation of cervical cancer death per 100,000 female
ipp_sd <- round(sd(cervical_cancer_death_year_as_row$Cervical_Cancer_Death, na.rm = TRUE), 2)
paste("The Standard Deviation of cervical cancer death per 100,000 female is ", ipp_sd, ".")

# Histogram showing cervical cancer death in different countries

hist(cervical_cancer_death$`2000`, xlab="Cervical Cancer Death Per 100,000 Female 2000", main="Cervical Cancer Deaths In Different Countries in 2000")
...
# Show the mean of liver cancer deaths per 100,000 persons of each country from 1955 to 2002
liver_cancer_death_year_as_row %>% 
  group_by(Country) %>% 
...
# Standard Deviation of liver cancer death per 100,000 person
ipp_sd <- round(sd(liver_cancer_death_year_as_row$Liver_Cancer_Death, na.rm = TRUE), 2)
paste("The Standard Deviation of liver cancer death per 100,000 person is ", ipp_sd, ".")
...
# Show the mean of lung cancer deaths per 100,000 persons of each country from 1950 to 2002
lung_cancer_death_year_as_row %>% 
  group_by(Country) %>% 
...
# Standard Deviation of prostate cancer death per 100,000 male
ipp_sd <- round(sd(prostate_cancer_death_year_as_row$Prostate_Cancer_Death, na.rm = TRUE), 2)
paste("The Standard Deviation of prostate cancer death per 100,000 person is ", ipp_sd, ".")
...
# Standard Deviation of prostate cancer death per 100,000 male
ipp_sd <- round(sd(prostate_cancer_death_year_as_row$Prostate_Cancer_Death, na.rm = TRUE), 2)
paste("The Standard Deviation of prostate cancer death per 100,000 male is ", ipp_sd, ".")

# Histogram showing prostate cancer death in different countries

hist(prostate_cancer_death$`2000`, xlab="Prostate Cancer Death Per 100,000 Male 2000", main="Prostate Cancer Deaths In Different Countries in 2000")
...
# Show the mean of stomach cancer deaths per 100,000 persons of each country from 1950 to 2002
stomach_cancer_death_year_as_row %>% 
  group_by(Country) %>% 
...
# Standard Deviation of stomach cancer death per 100,000 person
ipp_sd <- round(sd(stomach_cancer_death_year_as_row$Stomach_Cancer_Death, na.rm = TRUE), 2)
paste("The Standard Deviation of stomach cancer death per 100,000 person is ", ipp_sd, ".")
...
plot(Income_per_person, Life_Expectancy, main="Income vs Life Expectancy", 
  	xlab="GDP Per Capita (US$)", ylab="LIfe Expectancy At Birth-Year")
...
plot(Total_Health_Spending_Per_Person, Life_Expectancy, main="Health Spending vs Life Expectancy", 
  	xlab="Total Health Spending (US$)", ylab="LIfe Expectancy At Birth-Year")

```
```{r}
# Simple Scatterplot
attach(income_vs_life_vs_spending)
plot(Government_Health_Spending_Per_Person, Life_Expectancy, main="Government Health Spending vs Life Expectancy", 
  	xlab="Government Health Spending (US$)", ylab="LIfe Expectancy At Birth-Year")
