...
# Create subsets for income data of 1960, 1970, 1980, 1990, 2000, and 2010
...
# Bind rows in all subsets for income data of 1960, 1970, 1980, 1990, 2000, and 2010
...
ggplot(income_vs_life_expectancy_in_every10yrs, aes(x = Income_per_person, y = Life_Expectancy, fill = Year)) + geom_point(shape = 21) + xlim(0, 40000) + labs(x = "GDP Per Capita", y = "Life Expectancy (Year)", title = "Income and Life Expectancy by Year")

# Scatterplot - From US$0 - US$5000
ggplot(income_vs_life_expectancy_in_every10yrs, aes(x = Income_per_person, y = Life_Expectancy, fill = Year)) + geom_point(shape = 21) + xlim(0, 5000) + labs(x = "GDP Per Capita", y = "Life Expectancy (Year)", title = "Income and Life Expectancy by Year")
